...
public class DisplayHtml5Content extends Application {
    ...
    @Override public void start(Stage stage) {
        ...
        browser.getEngine().loadContent(SVGClock.SVG);
        Runnable updateClock = () -> {
            ...
            String updateTimeJs = "updateTime(%d, %d, %d);".formatted(hour, min, sec);
...
class SVGClock {
    public final static String SVG = """  
            ...
            function moveHands(secondAngle, minuteAngle, hourAngle) {
              ...
              secondHand.setAttribute("transform","rotate("+ secondAngle + ")") \s
